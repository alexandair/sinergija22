...
New-MgTeamChannelMessage -TeamId $team.Id -ChannelId $channel.Id -Body @{ Content="Hello, Sinergija22!" } -Importance "urgent"
...
# After granting admin consent, the browser will redirect back to http://localhost and display a Not Found error.
# This error can be ignored as long as the URL contains admin_consent=True.
# http://localhost/?admin_consent=True&tenant=XXXXXXXX-XXXX-XXXX-XXXX-XXXXXXXXXXXX#
